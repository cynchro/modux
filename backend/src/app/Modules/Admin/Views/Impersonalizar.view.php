...
<head>
  ...
  <link rel="icon" type="image/png" sizes="192x192" href="<?= base_url('AdminDist/assets/favicon/android-icon-19') ?>2x192.png">
  ...
  <link rel="icon" type="image/png" sizes="16x16" href="<?= base_url('AdminDist/a') ?>ssets/favicon/favicon-16x16.png">
...
<svg class="sidebar-brand-narrow"  height="32" alt="CoreUI Logo">
  ...
  <div class="wrapper d-flex flex-column min-vh-100">
      ...
      <div class="container-fluid px-4">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb my-0">
            <li class="breadcrumb-item"><a style="text-decoration: none; cursor: pointer;">Impersonalización</a></li>
          </ol>
        </nav>
      </div>
    </header>
      ...
      <div class="container mt-3">
        ...
        <div class="card mb-5">
          <div class="card-header d-flex justify-content-between align-items-center">
            <h5 class="card-title">Impersonalización</h5>
          </div>
          <div class="card-body">
                ...
                <div class="row">
                  <div class="col-sm-12">
                    <table id="myTable" class="table table-striped table-bordered dataTable no-footer" role="grid" aria-describedby="myTable_info" style="width: 1241px;">
                      <thead>
                        <tr role="row">
                          <th class="sorting_disabled" rowspan="1" colspan="1" style="width: 10px;">ID</th>
                          <th class="sorting_disabled" rowspan="1" colspan="1" style="width: 407px;">Usuario</th>
                        ...
                        <?php foreach ($usuarios as $u) { ?>
                          <tr role="row" class="odd">
                            ...
                            <td class=" text-center">
                              <button type="button" class="btn btn-warning btn-sm" onclick="impersonalizar(<?= $u['id']; ?>);">
                                <svg class="icon icon-lg">
                                  <use xlink:href="<?= base_url('AdminDist/vendor/@coreui/icons/svg/free.svg#cil-arrow-circle-right') ?>"></use>
                                </svg>
                              </button>
                            </td>
                          </tr>
    ...
    <script>
      function impersonalizar(targetUserId) {
        const adminUserId = 12;
        const data = {
          adminUserId: adminUserId,
          targetUserId: targetUserId
        };
        fetch('/admin/impersonalizar', {
            method: 'POST',
            headers: {
