    ...
    var table = $('#myTable').DataTable({
        ...
        "ajax": {
            ...
            "data": function (d) {
                ...
                const email = $('#emailFiltro').val();
                const id_sucursal = $('#id_sucursalFiltro').val();

                const filters = {};
                if (nombre) filters.nombre = nombre;
                if (email) filters.email = email;
                if (id_sucursal) filters.id_sucursal = id_sucursal;
        ...
        "columns": [
            ...
            { "data": "nombre_sucursal" },
            {
                ...
                "render": function (data) {
                    return `<button class="btn btn-warning btn-sm" data-bs-toggle="tooltip" data-bs-placement="top" title="Editar Empleado" onclick="editar(${data})">
                            <svg class="icon icon-xs"><use xlink:href="vendor/@coreui/icons/svg/free.svg#cil-pencil"></use></svg>
                            </button>
                            <button class="btn btn-danger btn-sm" data-bs-toggle="tooltip" data-bs-placement="top" title="Eliminar Empleado" onclick="eliminar(${data})">
...
function editar(id) {
    window.location.href = `empleadosABM.php?id=${id}`;
}
