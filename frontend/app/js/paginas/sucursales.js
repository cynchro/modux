        ...
        "columns": [
            ...
            { "data": "telefono" },
            {
                ...
                "render": function (data) {
                    return `<button class="btn btn-warning btn-sm" data-bs-toggle="tooltip" data-bs-placement="top" title="Editar Sucursal" onclick="editar(${data})">
...
function editar(id) {
    window.location.href = `sucursalesABM.php?id=${id}`;
}
