$(document).ready(function () {
    var table = $('#myTable').DataTable({
        ...
        "columns": [
            { "data": "nombreMaterial" },
            { "data": "nombreTipoMaterial" },
            { "data": "precio" },
            {
                "data": "id",
                "className": "text-center",
                "render": function (data) {
                    return `<button class="btn btn-warning btn-sm" data-bs-toggle="tooltip" data-bs-placement="top" title="Editar Materiales" onclick="editar(${data})">
                            <svg class="icon icon-xs"><use xlink:href="vendor/@coreui/icons/svg/free.svg#cil-pencil"></use></svg>
                            </button>
                            <button class="btn btn-danger btn-sm" data-bs-toggle="tooltip" data-bs-placement="top" title="Eliminar Materiales" onclick="eliminar(${data})">
...
function editar(id) {
    window.location.href = `materialesABM.php?id=${id}`;
}
