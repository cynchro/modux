...
$("#createEditSucursalForm").submit(function (e) {
  ...
  if (idForm) {
    actualizarCliente(idForm, { nombre, domicilio, telefono, email, id_localidad, id_tipo_documento, documento, id_condicion_iva });
  } else {
    crearCliente({ nombre, domicilio, telefono, email, id_localidad, id_tipo_documento, documento, id_condicion_iva });
  }
});
