    ...
    var table = $('#myTable').DataTable({
        ...
        "ajax": {
            ...
            "data": function (d) {
                ...
                const telefono = $('#telefonoFiltro').val();
                const domicilio = $('#domicilioFiltro').val();

                const filters = {};
                if (nombre) filters.nombre = nombre;
                if (telefono) filters.telefono = telefono;
                if (domicilio) filters.domicilio = domicilio;
        ...
        "columns": [
            ...
            { "data": "telefono" },
            {
                ...
                "render": function (data) {
                    return `<button class="btn btn-warning btn-sm" data-bs-toggle="tooltip" data-bs-placement="top" title="Editar Cliente" onclick="editar(${data})">
                            <svg class="icon icon-xs"><use xlink:href="vendor/@coreui/icons/svg/free.svg#cil-pencil"></use></svg>
                            </button>
                            <button class="btn btn-danger btn-sm" data-bs-toggle="tooltip" data-bs-placement="top" title="Eliminar Cliente" onclick="eliminar(${data})">
...
function editar(id) {
    window.location.href = `clientesABM.php?id=${id}`;
}
