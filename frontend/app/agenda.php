...
$menu = $router->checkAccess('pagina_clientes');
    ...
    <div class="body flex-grow-1">
      <div class="container-lg px-4">
        <div class="row g-4 mb-4">
          ...
          <div class="container mt-5">
                  ...
                  <div class="d-flex justify-content-between align-items-start">
                    <div class="d-flex gap-3">
                      ...
                      <div>
                        ...
                        <input type="text" id="nombreFiltro" class="form-control" placeholder="Ingrese el Nombre">
                      </div>
                      <!-- Filtro Teléfono -->
                      <div>
                        <label for="telefonoFiltro" class="form-label">Teléfono</label>
                        <input type="text" id="telefonoFiltro" class="form-control" placeholder="Ingrese el Teléfono">
                      </div>
                      <!-- Filtro Domicilio -->
                      <div>
                        <label for="domicilioFiltro" class="form-label">Domicilio</label>
                        <input type="text" id="domicilioFiltro" class="form-control" placeholder="Ingrese el Domicilio">
                      </div>
                    </div>
            ...
            <div class="card">
              <div class="card-header d-flex justify-content-between align-items-center">
                ...
                <a class="btn btn-success" href="clientesABM.php">Crear Cliente</a>
              </div>
              <div class="card-body">
          ...
          <script src="js/paginas/clientes.js"></script>
