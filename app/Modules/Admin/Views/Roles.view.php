      ...
      <div class="container mt-5">
        ...
        <div class="card">
          <div class="card-header d-flex justify-content-between align-items-center">
            ...
            <a class="btn btn-success" href="roles/abm/0">Crear Rol</a>
          </div>
          <div class="card-body">
                ...
                <div class="row">
                  <div class="col-sm-12">
                    <table id="myTable" class="table table-striped table-bordered dataTable no-footer" role="grid" aria-describedby="myTable_info" style="width: 1241px;">
                      <thead>
                        <tr role="row">
                          <th class="sorting_disabled" rowspan="1" colspan="1" style="width: 177px;">Nombre</th>
                      ...
                      <tbody>
                        ...
                        <tr role="row" class="odd">
                          <td><?= $r['nombre']; ?></td>
                          <td><?= $r['estado'] == 0 ? 'habilitado' : 'suspendido';?></td>
                          <td class=" text-center">
                            <a class="btn btn-warning btn-sm" href="roles/abm/<?= $r['id']; ?>">
